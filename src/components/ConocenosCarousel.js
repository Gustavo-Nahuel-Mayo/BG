...
const ConocenosCarousel = () => {
    return(
            <div id="conocenosCarousel" className="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <button className="carousel-control-prev" type="button" data-bs-target="#conocenosCarousel" data-bs-slide="prev">
                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                <span className="visually-hidden">Previous</span>
            </button>
            <button className="carousel-control-next" type="button" data-bs-target="#conocenosCarousel" data-bs-slide="next">
