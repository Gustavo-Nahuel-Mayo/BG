...
const EscolaresCarousel1 = () => {
    return(
            <div id="escolaresCarousel1" className="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <button className="carousel-control-prev" type="button" data-bs-target="#escolaresCarousel1" data-bs-slide="prev">
                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                <span className="visually-hidden">Previous</span>
            </button>
            <button className="carousel-control-next" type="button" data-bs-target="#escolaresCarousel1" data-bs-slide="next">
...
export default EscolaresCarousel1;
